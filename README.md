[![deploy_github_pages](https://github.com/nenuadrian/DI-engine/actions/workflows/deploy_github_pages.yml/badge.svg)](https://github.com/nenuadrian/DI-engine/actions/workflows/deploy_github_pages.yml)
...
| 58 |                    [GTrXL V-MPO](https://arxiv.org/abs/1910.06764)/[V-MPO](https://arxiv.org/abs/1909.12238)                     |                                                        ![discrete](https://img.shields.io/badge/-discrete-brightgreen)                                                        | [policy/vmpo](https://github.com/opendilab/DI-engine/blob/main/ding/policy/vmpo.py)<br>[config/pong_vmpo_gtrxl](https://github.com/opendilab/DI-engine/blob/main/dizoo/atari/config/serial/pong/pong_vmpo_gtrxl_config.py) |                    ding -m serial_onpolicy -c pong_vmpo_gtrxl_config.py -s 0                    |
